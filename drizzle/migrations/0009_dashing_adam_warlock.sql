...
--> statement-breakpoint
CREATE UNIQUE INDEX `stf_quarter_name_unique` ON `stf_quarter` (`name`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_orders`("id", "user_id", "fund_type", "stf_bucket_id", "quarter_id", "vendor", "link", "item_name", "part_number", "quantity", "unit_cost_cents", "notes", "status", "denial_comment", "reviewed_by", "reviewed_at", "created_at") SELECT "id", "user_id", "fund_type", "stf_bucket_id", "quarter_id", "vendor", "link", "item_name", "part_number", "quantity", "unit_cost_cents", "notes", "status", "denial_comment", "reviewed_by", "reviewed_at", "created_at" FROM `orders`;--> statement-breakpoint
